...
export default function Navbar() {
  return (
    <nav className="bg-transparent top-0 left-0 w-full flex justify-between items-center px-8 py-4 relative font-[Manrope] before:fixed before:left-0 before:top-0 before:-z-10 before:h-[435px] before:w-full before:rounded-bl-3xl before:bg-[#EAE6D7] max-md:px-4 lg:text-lg before:lg:rounded-bl-[79px] ">
